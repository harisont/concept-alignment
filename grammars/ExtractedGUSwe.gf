concrete ExtractedGUSwe of ExtractedGU = ExtractSwe ** open MorphoDictSwe, ParadigmsSwe, MakeStructuralSwe in { -- Swe
...
--- lin language_markovmodell_CN = markovmodell_Adv ; -- Swe
oper markovmodell_Adv = mkAdv "markovmodell" ; -- Swe
...
lin Construct_Konstruera_Utt = UttVP (UseV Konstruera_V) ; -- Swe
...
oper datatyp_N = mkN "datatyp" ; -- Swe
lin acquaint_bli_Utt = UttVP (UseV bli_V) ; -- Swe
lin acquire_inhämta_Utt = UttVP (UseV inhämta_V) ; -- Swe
...
lin advanced_basera_Utt = UttVP (UseV basera_V) ; -- Swe
lin affect_beträffa_Utt = UttVP (UseV beträffa_V) ; -- Swe
lin affect_påverka_Utt = UttVP (UseV påverka_V) ; -- Swe
lin allow_göra_Utt = UttVP (UseV göra_V) ; -- Swe
--- lin applied_maskininlärning_Utt = UseN maskininlärning_N ; -- Swe
oper maskininlärning_N = mkN "maskininlärning" ; -- Swe
lin apply_tillämpa_Utt = UttVP (UseV tillämpa_V) ; -- Swe
lin appreciate_uppskatta_Utt = UttVP (UseV uppskatta_V) ; -- Swe
lin appro_godkänd_Utt = UttVP (UseV godkänd_V) ; -- Swe
oper godkänd_V = mkV "godkänd" ; -- Swe
lin ask_bli_Utt = UttVP (UseV bli_V) ; -- Swe
lin assess_tillhöra_Utt = UttVP (UseV tillhöra_V) ; -- Swe
lin avoid_välja_Utt = UttVP (UseV välja_V) ; -- Swe
--- lin base_c_Utt = UsePN c_PN ; -- Swe
oper c_PN = mkPN "c" ; -- Swe
lin base_presentera_Utt = UttVP (UseV presentera_V) ; -- Swe
--- lin base_basera_Utt = basera_A ; -- Swe
oper basera_A = mkA "basera" ; -- Swe
lin be_finnas_Utt = UttVP (UseV finnas_V) ; -- Swe
oper finnas_V = mkV "finnas" ; -- Swe
lin be_handla_Utt = UttVP (UseV handla_V) ; -- Swe
oper handla_V = mkV "handla" ; -- Swe
lin be_renommera_Utt = UttVP (UseV renommera_V) ; -- Swe
oper renommera_V = mkV "renommera" ; -- Swe
lin capture_representera_Utt = UttVP (UseV representera_V) ; -- Swe
oper representera_V = mkV "representera" ; -- Swe
--- lin communicate_kommunicering_Utt = UseN kommunicering_N ; -- Swe
lin communicate_kommunicera_Utt = UttVP (UseV kommunicera_V) ; -- Swe
oper kommunicera_V = mkV "kommunicera" ; -- Swe
--- lin compound_datastruktur_Utt = UseN datastruktur_N ; -- Swe
oper datastruktur_N = mkN "datastruktur" ; -- Swe
lin compute_bestämma_Utt = UttVP (UseV bestämma_V) ; -- Swe
--- lin concepts_grundbegrepp_Utt = UseN grundbegrepp_N ; -- Swe
lin consider_betrakta_Utt = UttVP (UseV betrakta_V) ; -- Swe
lin consist_bestå_Utt = UttVP (UseV bestå_V) ; -- Swe
oper bestå_V = mkV "bestå" ; -- Swe
--- lin construct_programmering_Utt = UseN programmering_N ; -- Swe
lin contain_innehålla_Utt = UttVP (UseV innehålla_V) ; -- Swe
--- lin control_styrsystem_Utt = UseN styrsystem_N ; -- Swe
lin correspond_motsvara_Utt = UttVP (UseV motsvara_V) ; -- Swe
--- lin cover_delområde_Utt = UseN delområde_N ; -- Swe
oper delområde_N = mkN "delområde" ; -- Swe
--- lin cover_tekniker_Utt = UseN tekniker_N ; -- Swe
lin cover_innehålla_Utt = UttVP (UseV innehålla_V) ; -- Swe
lin cover_omfatta_Utt = UttVP (UseV omfatta_V) ; -- Swe
lin cover_täcka_Utt = UttVP (UseV täcka_V) ; -- Swe
lin deal_behandla_Utt = UttVP (UseV behandla_V) ; -- Swe
lin deal_handla_Utt = UttVP (UseV handla_V) ; -- Swe
oper handla_V = mkV "handla" ; -- Swe
lin demonstrate_demonstrera_Utt = UttVP (UseV demonstrera_V) ; -- Swe
oper demonstrera_V = mkV "demonstrera" ; -- Swe
lin describe_beskriva_Utt = UttVP (UseV beskriva_V) ; -- Swe
lin design_konstruerad_Utt = UttVP (UseV konstruerad_V) ; -- Swe
oper konstruerad_V = mkV "konstruerad" ; -- Swe
lin detect_upptäcka_Utt = UttVP (UseV upptäcka_V) ; -- Swe
lin determine_bestämma_Utt = UttVP (UseV bestämma_V) ; -- Swe
lin develop_utveckla_Utt = UttVP (UseV utveckla_V) ; -- Swe
lin directly_mäta_Utt = UttVP (UseV mäta_V) ; -- Swe
--- lin discuss_teori_Utt = UseN teori_N ; -- Swe
oper teori_N = mkN "teori" ; -- Swe
lin discuss_diskutera_Utt = UttVP (UseV diskutera_V) ; -- Swe
...
lin divide_indela_Utt = UttVP (UseV indela_V) ; -- Swe
lin divide_uppdela_Utt = UttVP (UseV uppdela_V) ; -- Swe
--- lin do_Laboration_Utt = UseN Laboration_N ; -- Swe
oper Laboration_N = mkN "Laboration" ; -- Swe
--- lin e_Computer_Utt = UsePN Computer_PN ; -- Swe
oper Computer_PN = mkPN "Computer" ; -- Swe
lin estimate_uppskatta_Utt = UttVP (UseV uppskatta_V) ; -- Swe
lin exemplify_exemplifiera_Utt = UttVP (UseV exemplifiera_V) ; -- Swe
lin exist_finnas_Utt = UttVP (UseV finnas_V) ; -- Swe
oper finnas_V = mkV "finnas" ; -- Swe
--- lin explain_egenskap_Utt = UseN egenskap_N ; -- Swe
--- lin explain_syfte_Utt = UseN syfte_N ; -- Swe
lin explain_redogöra_Utt = UttVP (UseV redogöra_V) ; -- Swe
lin explore_utforska_Utt = UttVP (UseV utforska_V) ; -- Swe
--- lin express_formel_Utt = UseN formel_N ; -- Swe
lin find_hitta_Utt = UttVP (UseV hitta_V) ; -- Swe
--- lin flow_nätverksflöde_Utt = UseN nätverksflöde_N ; -- Swe
oper nätverksflöde_N = mkN "nätverksflöde" ; -- Swe
lin focus_behandla_Utt = UttVP (UseV behandla_V) ; -- Swe
lin focus_fokusera_Utt = UttVP (UseV fokusera_V) ; -- Swe
lin follow_följa_Utt = UttVP (UseV följa_V) ; -- Swe
lin formulate_formulera_Utt = UttVP (UseV formulera_V) ; -- Swe
lin give_ge_Utt = UttVP (UseV ge_V) ; -- Swe
--- lin have_datavetenskap_Utt = UseN datavetenskap_N ; -- Swe
oper datavetenskap_N = mkN "datavetenskap" ; -- Swe
lin have_avklara_Utt = UttVP (UseV avklara_V) ; -- Swe
oper avklara_V = mkV "avklara" ; -- Swe
lin have_flytta_Utt = UttVP (UseV flytta_V) ; -- Swe
lin have_ha_Utt = UttVP (UseV ha_V) ; -- Swe
--- lin idealise_dator_Utt = UseN dator_N ; -- Swe
--- lin identify_styrka_Utt = UseN styrka_N ; -- Swe
lin implement_realisera_Utt = UttVP (UseV realisera_V) ; -- Swe
--- lin include_Examination_Utt = UseN Examination_N ; -- Swe
oper Examination_N = mkN "Examination" ; -- Swe
lin include_behandla_Utt = UttVP (UseV behandla_V) ; -- Swe
lin include_bestå_Utt = UttVP (UseV bestå_V) ; -- Swe
oper bestå_V = mkV "bestå" ; -- Swe
--- lin including_hp_Utt = UseN hp_N ; -- Swe
oper hp_N = mkN "hp" ; -- Swe
lin intend_avse_Utt = UttVP (UseV avse_V) ; -- Swe
lin intend_syfta_Utt = UttVP (UseV syfta_V) ; -- Swe
lin introduce_introducera_Utt = UttVP (UseV introducera_V) ; -- Swe
lin investigate_undersöka_Utt = UttVP (UseV undersöka_V) ; -- Swe
lin involve_omfatta_Utt = UttVP (UseV omfatta_V) ; -- Swe
...
oper learning_N = mkN "learning" ; -- Swe
lin learn_Algoritmer_Utt = UttVP (UseV Algoritmer_V) ; -- Swe
oper Algoritmer_V = mkV "Algoritmer" ; -- Swe
lin learn_lära_Utt = UttVP (UseV lära_V) ; -- Swe
lin level_behandla_Utt = UttVP (UseV behandla_V) ; -- Swe
lin limit_omfatta_Utt = UttVP (UseV omfatta_V) ; -- Swe
lin look_behandla_Utt = UttVP (UseV behandla_V) ; -- Swe
--- lin loop_unrolling_Utt = UseN unrolling_N ; -- Swe
oper unrolling_N = mkN "unrolling" ; -- Swe
lin make_göra_Utt = UttVP (UseV göra_V) ; -- Swe
lin manipulate_manipulera_Utt = UttVP (UseV manipulera_V) ; -- Swe
lin mean_använda_Utt = UttVP (UseV använda_V) ; -- Swe
lin measure_mäta_Utt = UttVP (UseV mäta_V) ; -- Swe
--- lin mechanism_mekanismer_Utt = mekanismer_A ; -- Swe
oper mekanismer_A = mkA "mekanismer" ; -- Swe
lin meet_kre_Utt = UttVP (UseV kre_V) ; -- Swe
oper kre_V = mkV "kre" ; -- Swe
lin mining_använda_Utt = UttVP (UseV använda_V) ; -- Swe
--- lin modelle_Modellering_Utt = UseN Modellering_N ; -- Swe
oper Modellering_N = mkN "Modellering" ; -- Swe
lin modelling_modellera_Utt = UttVP (UseV modellera_V) ; -- Swe
lin need_Utvärdera_Utt = UttVP (UseV Utvärdera_V) ; -- Swe
oper Utvärdera_V = mkV "Utvärdera" ; -- Swe
lin need_behöver_Utt = UttVP (UseV behöver_V) ; -- Swe
oper behöver_V = mkV "behöver" ; -- Swe
lin need_vara_Utt = UttVP (UseV vara_V) ; -- Swe
oper vara_V = mkV "vara" ; -- Swe
lin obtain_bestämma_Utt = UttVP (UseV bestämma_V) ; -- Swe
lin obtain_upprätthålla_Utt = UttVP (UseV upprätthålla_V) ; -- Swe
--- lin organize_föreläsningsserie_Utt = UseN föreläsningsserie_N ; -- Swe
oper föreläsningsserie_N = mkN "föreläsningsserie" ; -- Swe
lin organize_organiserad_Utt = UttVP (UseV organiserad_V) ; -- Swe
...
lin parallelize_parallellisera_Utt = UttVP (UseV parallellisera_V) ; -- Swe
--- lin parse_parsningsalgoritmer_Utt = UseN parsningsalgoritmer_N ; -- Swe
oper parsningsalgoritmer_N = mkN "parsningsalgoritmer" ; -- Swe
lin perform_utföra_Utt = UttVP (UseV utföra_V) ; -- Swe
lin pertain_röra_Utt = UttVP (UseV röra_V) ; -- Swe
...
lin present_presentera_Utt = UttVP (UseV presentera_V) ; -- Swe
--- lin present_ombedd_Utt = ombedd_A ; -- Swe
oper ombedd_A = mkA "ombedd" ; -- Swe
lin problem_Modellera_Utt = UttVP (UseV Modellera_V) ; -- Swe
...
lin programme_använda_Utt = UttVP (UseV använda_V) ; -- Swe
lin programming_Implementera_Utt = UttVP (UseV Implementera_V) ; -- Swe
oper Implementera_V = mkV "Implementera" ; -- Swe
lin provide_ge_Utt = UttVP (UseV ge_V) ; -- Swe
lin put_sitta_Utt = UttVP (UseV sitta_V) ; -- Swe
--- lin randomize_algoritmer_Utt = UseN algoritmer_N ; -- Swe
oper algoritmer_N = mkN "algoritmer" ; -- Swe
lin read_läsa_Utt = UttVP (UseV läsa_V) ; -- Swe
--- lin recommend_rekommenderad_Utt = rekommenderad_A ; -- Swe
oper rekommenderad_A = mkA "rekommenderad" ; -- Swe
lin reduce_angripa_Utt = UttVP (UseV angripa_V) ; -- Swe
lin relate_relatera_Utt = UttVP (UseV relatera_V) ; -- Swe
--- lin require_krav_Utt = UseN krav_N ; -- Swe
--- lin rout_LAN_Utt = UsePN LAN_PN ; -- Swe
oper LAN_PN = mkPN "LAN" ; -- Swe
lin save_spara_Utt = UttVP (UseV spara_V) ; -- Swe
oper spara_V = mkV "spara" ; -- Swe
--- lin scheduling_hantering_Utt = UseN hantering_N ; -- Swe
lin show_beskriva_Utt = UttVP (UseV beskriva_V) ; -- Swe
lin solve_lösa_Utt = UttVP (UseV lösa_V) ; -- Swe
lin specify_specificera_Utt = UttVP (UseV specificera_V) ; -- Swe
--- lin structur_strukturering_Utt = UseN strukturering_N ; -- Swe
lin structure_användbara_Utt = UttVP (UseV användbara_V) ; -- Swe
oper användbara_V = mkV "användbara" ; -- Swe
lin study_studera_Utt = UttVP (UseV studera_V) ; -- Swe
lin support_Deep_Utt = UttVP (UseV Deep_V) ; -- Swe
...
lin take_ske_Utt = UttVP (UseV ske_V) ; -- Swe
lin teach_bestå_Utt = UttVP (UseV bestå_V) ; -- Swe
oper bestå_V = mkV "bestå" ; -- Swe
--- lin tes_testning_Utt = UseN testning_N ; -- Swe
oper testning_N = mkN "testning" ; -- Swe
lin tes_ter_Utt = UttVP (UseV ter_V) ; -- Swe
oper ter_V = mkV "ter" ; -- Swe
lin training_bia_Utt = UttVP (UseV bia_V) ; -- Swe
oper bia_V = mkV "bia" ; -- Swe
--- lin understand_förståelse_Utt = UseN förståelse_N ; -- Swe
lin understand_redogöra_Utt = UttVP (UseV redogöra_V) ; -- Swe
lin unrolle_predicatida_Utt = UttVP (UseV predicatida_V) ; -- Swe
oper predicatida_V = mkV "predicatida" ; -- Swe
--- lin use_användning_Utt = UseN användning_N ; -- Swe
--- lin use_fokus_Utt = UseN fokus_N ; -- Swe
oper fokus_N = mkN "fokus" ; -- Swe
lin use_använda_Utt = UttVP (UseV använda_V) ; -- Swe
lin use_demonstrera_Utt = UttVP (UseV demonstrera_V) ; -- Swe
oper demonstrera_V = mkV "demonstrera" ; -- Swe
lin use_tillämpa_Utt = UttVP (UseV tillämpa_V) ; -- Swe
