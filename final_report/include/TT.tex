...
% pros
Intuitively, this makes it so that dependency trees are simpler, which makes them an easier target for the frontend, possibly ML-based, of a MT system such as the one outlined in the above. 
