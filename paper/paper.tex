...
\begin{table*}[h]
  ...
  \end{tabular}
  \caption{Comparison between the extraction of alignments of any size from manually annotated PUD treebanks and from automatically parsed sentences from the course plans corpora.}
  \label{raw_fast}
  \end{table*}
