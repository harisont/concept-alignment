...
In this paper, however, we focus on CE, and restrict its application to bilingual corpora. 
...
This work is a new attempt in the same direction, enabled by two interlingually oriented grammar formalisms developed over the course of the last 25 years: Universal Dependencies (UD) \cite{TODO:} and Grammatical Framework (GF) \cite{TODO:}.
...
\subsubsection{Refinements of the basic algorithm}
